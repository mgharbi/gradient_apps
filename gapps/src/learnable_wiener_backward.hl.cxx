...
public:
    ...
    Output<Buffer<float>> d_output{"output", 3};

    Output<Buffer<float>>  d_reg_kernel{"d_mosaick", 3};
    ...
    void generate() {
        ...
        Func f_reg_kernel = adjoints[FuncKey{f_reg_kernel.name(), -1}];
        d_reg_kernel(x) = f_reg_kernel(x);
    }
};
